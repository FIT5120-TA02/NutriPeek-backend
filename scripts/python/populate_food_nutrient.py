...
def transform_data(df: pd.DataFrame) -> List[Dict]:
    ...
    column_mapping = {
        ...
        "Available carbohydrates, with sugar alcohols (g)": "carbs_with_sugar_alcohols_g",
        "Available carbohydrates, without sugar alcohol (g)": "carbs_without_sugar_alcohols_g",
        "Starch (g)": "starch_g",
        ...
        "Alcohol (g)": "alcohol_g",
        "Ash (g)": "ash_g",
        "Preformed vitamin A (retinol) (Âµg)": "vitamin_a_retinol_ug",
        "Beta-carotene (Âµg)": "beta_carotene_ug",
        "Provitamin A (b-carotene equivalents) (Âµg)": "provitamin_a_equivalents_ug",
        "Vitamin A retinol equivalents (Âµg)": "vitamin_a_re_ug",
        "Thiamin (B1) (mg)": "thiamin_b1_mg",
        "Riboflavin (B2) (mg)": "riboflavin_b2_mg",
        "Niacin (B3) (mg)": "niacin_b3_mg",
        "Niacin derived equivalents (mg)": "niacin_equivalents_mg",
        "Folate, natural  (Âµg)": "folate_natural_ug",
        "Folic acid  (Âµg)": "folic_acid_ug",
        "Total Folates  (Âµg)": "total_folates_ug",
        "Dietary folate equivalents  (Âµg)": "dietary_folate_equivalents_ug",
        "Vitamin B6 (mg)": "vitamin_b6_mg",
        "Vitamin B12  (Âµg)": "vitamin_b12_ug",
        "Vitamin C (mg)": "vitamin_c_mg",
        "Alpha-tocopherol (mg)": "alpha_tocopherol_mg",
        "Vitamin E (mg)": "vitamin_e_mg",
        "Calcium (Ca) (mg)": "calcium_mg",
        "Iodine (I) (Âµg)": "iodine_ug",
        "Iron (Fe) (mg)": "iron_mg",
        "Magnesium (Mg) (mg)": "magnesium_mg",
        "Phosphorus (P) (mg)": "phosphorus_mg",
        "Potassium (K) (mg)": "potassium_mg",
        "Selenium (Se) (Âµg)": "selenium_ug",
        "Sodium (Na) (mg)": "sodium_mg",
        "Zinc (Zn) (mg)": "zinc_mg",
        "Caffeine (mg)": "caffeine_mg",
        "Cholesterol (mg)": "cholesterol_mg",
        "Tryptophan (mg)": "tryptophan_mg",
        "Total saturated fat (g)": "saturated_fat_g",
        "Total monounsaturated fat (g)": "monounsaturated_fat_g",
        "Total polyunsaturated fat (g)": "polyunsaturated_fat_g",
        ...
        "Total long chain omega 3 fatty acids (mg)": "omega3_long_chain_total_mg",
        "Total trans fatty acids (mg)": "trans_fatty_acids_mg",
    }
